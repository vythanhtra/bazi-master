...
const explicitWebPort = resolvePort(process.env.E2E_WEB_PORT) ?? resolvePort(process.env.PW_PORT);
const webPort = explicitWebPort ?? (noWebServer ? fallbackPort : await pickSafePort());
...
const explicitBackendPort =
  resolvePort(process.env.E2E_API_PORT) ?? resolvePort(process.env.BACKEND_PORT);
