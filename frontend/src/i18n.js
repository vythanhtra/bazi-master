    ...
    translation: {
      ...
      login: {
        ...
        errors: {
          ...
          resetRequestFailed: 'Unable to request reset.',
      ...
      history: {
        subtitle: 'Review and manage your saved BaZi records.',
        ...
        importing: 'Importing...',
        importSuccess_one: 'Imported {{count}} record.',
        importSuccess_other: 'Imported {{count}} records.',
        ...
        exportNoMatches: 'No records matched your export filters.',
        exportSuccess: 'History exported.',
        exportAllSuccess: 'Full history exported.',
        ...
        bulkDeleteTitle_one: 'Delete {{count}} selected record?',
        bulkDeleteTitle_other: 'Delete {{count}} selected records?',
        bulkDeleteDesc: 'This removes the selected records from your history. You can restore them later.',
        deleteSelected: 'Delete selected',
        bulkDeleted_one: 'Deleted {{count}} record.',
        bulkDeleted_other: 'Deleted {{count}} records.',
        bulkAlreadyDeleted: 'Selected records already deleted.',
        bulkDeleteRestoredError: 'Unable to delete selected records. They have been restored.',
        deleteConfirmTitle: 'Delete this record?',
        deleteConfirmDesc: 'This removes the record from your history. You can restore it later.',
        hardDeleteConfirmTitle: 'Delete permanently?',
        hardDeleteConfirmDesc: 'This removes the record from your account forever. This cannot be undone.',
        recordDeleted: 'Record deleted.',
        alreadyDeleted: 'Record already deleted.',
        alreadyRemoved: 'Record already removed.',
        restoreUnavailable: 'Record is no longer available to restore.',
        restoreError: 'Unable to restore record.',
        deleteError: 'Unable to delete record.',
        deleteRestoredError: 'Unable to delete record. It has been restored.',
        deletePermanentError: 'Unable to permanently delete record.',
        updateError: 'Unable to update record.',
        fixFields: 'Fix the highlighted fields to continue.',
        timeHexagramError: 'Unable to reveal the time hexagram.',
        yearPillar: 'Year Pillar',
        dayPillar: 'Day Pillar',
        pageOf: 'Page {{current}} of {{total}}',
        sharedLoaded: 'Shared record loaded',
        clearLink: 'Clear link',
        errorLoadingShared: 'Unable to load shared record.',
        sharedMissingDesc: 'This link points to a record that no longer exists or you no longer have access.',
        sharedErrorDesc: 'Please try again or remove the record link from the URL.',
        tarotArchive: 'Tarot Archive',
        tarotSubtitle: 'Review your saved tarot readings.',
        startThreeCard: 'Start Three Card',
        refresh: 'Refresh',
        refreshing: 'Refreshing...',
        noTarotYet: 'No tarot readings yet.',
        generalReading: 'General Reading',
        tarotLoadError: 'Unable to load tarot history.',
        deletedLoadError: 'Unable to load deleted records.',
        noHistoryYet: 'No history yet',
        noHistoryYetDesc: 'Create a reading, then save it to see it here.',
        birth: 'Birth',
        profile: 'Profile',
      ...
      profile: {
        ...
        providersEnabled_one: '{{count}} provider enabled.',
        providersEnabled_other: '{{count}} providers enabled.',
        noProvidersEnabled: 'No providers enabled. Using fallback summaries.',
        saveSettings: 'Save settings',
        saving: 'Saving...',
        settingsSaved: 'Settings saved.',
        loadError: 'Unable to save settings.',
        ...
        removeError: 'Unable to delete account.',
  ...
  'zh-CN': {
    translation: {
      ...
      history: {
        ...
        exportAll: '导出全部',
        exporting: '导出中...', 
        exportError: '无法导出历史记录。',
        importFile: '导入文件',
        importing: '导入中...',
        importSuccess_one: '已成功导入 {{count}} 条记录。',
        importSuccess_other: '已成功导入 {{count}} 条记录。',
        importError: '无法导入记录。',
        importNoRecords: '文件中未找到记录。',
        noRecordsToExport: '没有可导出的记录。',
        exportNoMatches: '没有匹配当前筛选条件的记录。',
        exportSuccess: '历史记录导出成功。',
        exportAllSuccess: '完整历史记录已导出。',
        ...
        invalidDate: '无效的日期。',
        bulkDeleteTitle_one: '删除选中的 {{count}} 条记录？',
        bulkDeleteTitle_other: '删除选中的 {{count}} 条记录？',
        bulkDeleteDesc: '这将把选中的记录从历史中移除。你可以稍后恢复它们。',
        deleteSelected: '删除选中',
        bulkDeleted_one: '已删除 {{count}} 条记录。',
        bulkDeleted_other: '已删除 {{count}} 条记录。',
        bulkAlreadyDeleted: '选中的记录已被删除。',
        bulkDeleteRestoredError: '无法删除选中的记录，已恢复。',
        deleteConfirmTitle: '删除此记录？',
        deleteConfirmDesc: '这将把该记录从历史中移除。你可以稍后恢复它。',
        hardDeleteConfirmTitle: '永久删除？',
        hardDeleteConfirmDesc: '这将从你的账号中永久移除此记录，且无法撤销。',
        recordDeleted: '记录已删除。',
        alreadyDeleted: '记录已被删除。',
        alreadyRemoved: '记录已被移除。',
        restoreUnavailable: '该记录已无法恢复。',
        restoreError: '无法恢复记录。',
        deleteError: '无法删除记录。',
        deleteRestoredError: '无法删除记录，已恢复。',
        deletePermanentError: '无法永久删除记录。',
        updateError: '无法更新记录。',
        fixFields: '请修正高亮显示的字段以继续。',
        timeHexagramError: '无法揭示时间卦象。',
        yearPillar: '年柱',
        dayPillar: '日柱',
        pageOf: '第 {{current}} 页，共 {{total}} 页',
        sharedLoaded: '已加载分享记录',
        clearLink: '清除链接',
        errorLoadingShared: '无法加载分享记录。',
        sharedMissingDesc: '该链接指向的记录可能已被删除，或你已无权限访问。',
        sharedErrorDesc: '请重试，或从 URL 中移除记录链接参数。',
        tarotArchive: '塔罗档案',
        tarotSubtitle: '查看你保存的塔罗解读。',
        startThreeCard: '开始三张牌',
        refresh: '刷新',
        refreshing: '刷新中…',
        noTarotYet: '暂无塔罗记录。',
        generalReading: '常规解读',
        tarotLoadError: '无法加载塔罗历史。',
        deletedLoadError: '无法加载已删除记录。',
        noHistoryYet: '暂无历史记录',
        noHistoryYetDesc: '先完成一次排盘并保存，即可在此查看。',
        birth: '出生',
        profile: '资料',
        selectAll: '全选',
        selectedCount_one: '已选中 {{count}} 条',
        selectedCount_other: '已选中 {{count}} 条',
        clear: '清除',
      ...
      profile: {
        ...
        providersEnabled_one: '{{count}} 个提供商已启用。',
        providersEnabled_other: '{{count}} 个提供商已启用。',
        noProvidersEnabled: '未启用提供商。使用回退摘要。',
        saveSettings: '保存设置',
        saving: '保存中…',
        settingsSaved: '设置已保存。',
        loadError: '无法保存设置。',
        recordsLoadError: '无法加载记录。',
        cancel: '取消',
        dangerZone: '危险区域',
      ...
      tarot: {
        ...
        celticPositions: {
          p1: { label: '现状', meaning: '你当前的情况或问题的核心。' },
          p2: { label: '挑战', meaning: '障碍、压力或交叉的影响。' },
          p3: { label: '过去', meaning: '近期发生的事件或正在消退的影响。' },
          p4: { label: '未来', meaning: '近期的发展方向或下一步。' },
          p5: { label: '意识', meaning: '有意识的目标、抱负或理想。' },
          p6: { label: '潜意识', meaning: '潜意识的根源、基础或隐藏的动机。' },
          p7: { label: '建议', meaning: '关于如何应对或继续的指引。' },
          p8: { label: '外部', meaning: '外部影响、他人或环境。' },
          p9: { label: '希望/恐惧', meaning: '内心的渴望、焦虑或期待。' },
          p10: { label: '结果', meaning: '如果保持现状，最可能出现的结果。' }
        },
        position: '位置',
        reversed: '逆位',
        spreads: {
  ...
  'zh-TW': {
    translation: {
      ...
      common: {
        ...
        month: '月',
        day: '日',
        loadingAccount: '正在載入帳號資訊...',
        loadAccountError: '無法載入你的帳號資訊，請重試。',
        signInAgain: '重新登入'
      },
      errors: {
        network: '網路錯誤，請檢查連線後重試。',
        unknown: '發生未預期的錯誤。',
        offline: '你目前處於離線狀態，請重新連線後再試。',
        unsavedChanges: '你有尚未儲存的變更，確定要離開此頁面嗎？',
        saveInProgress: '正在儲存中，請等待完成後再離開此頁面。',
        loadLocations: '無法載入地點資訊。',
        actionQueued: '{{label}} 已加入重試佇列。',
        itemsFailed: '{{count}} 個項目失敗'
      }
    }
  }
};
