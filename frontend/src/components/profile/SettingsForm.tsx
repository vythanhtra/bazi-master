      ...
      <form onSubmit={saveSettings} className="mt-6 space-y-6">
        <label className="block text-sm text-white/70">
          ...
          >
            ...
            <option value="zh-CN" className="bg-slate-900 text-white">
              中文（简体）
            </option>
            <option value="zh-TW" className="bg-slate-900 text-white">
              中文（繁體）
            </option>
          </select>
        </label>
          ...
          <div className="mt-4 grid gap-3 md:grid-cols-2">
              ...
              >
                ...
                {aiProviders.map((provider) => (
                  ...
                  >
                    ...
                    {provider.enabled ? '' : `(${t('profile.unavailable')})`}
                  </option>
                ))}
              </select>
            </label>
            <div className="rounded-xl border border-white/10 bg-white/5 p-4 text-xs text-white/60">
              ...
              <p className="mt-2 text-sm text-white">
                {activeProvider ? activeProvider.toUpperCase() : t('profile.unknown')}
              </p>
              <p className="mt-2">
