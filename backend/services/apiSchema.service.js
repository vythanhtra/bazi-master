export const buildOpenApiSpec = ({ baseUrl } = {}) => ({
    ...
    schemas: {
      ...
      BaziRecord: {
        ...
        properties: {
          ...
          birthYear: { type: 'integer', description: '出生年份' },
          birthMonth: { type: 'integer', description: '出生月份' },
          birthDay: { type: 'integer', description: '出生日期' },
          birthHour: { type: 'integer', description: '出生小时' },
          birthLocation: { type: 'string', description: '出生地点' },
          pillars: {
            type: 'object',
            description: '八字柱信息',
            properties: {
          ...
          tenGods: { type: 'object', description: '十神信息' },
          luckCycles: { type: 'object', description: '运势周期' },
      ...
      Favorite: {
        type: 'object',
        properties: {
          id: { type: 'integer', description: '收藏ID' },
          userId: { type: 'integer', description: '用户ID' },
          recordId: { type: 'integer', description: '记录ID' },
          record: { $ref: '#/components/schemas/BaziRecord' },
          createdAt: { type: 'string', format: 'date-time' },
        },
      },
      BaziCalculationRequest: {
        ...
        properties: {
          birthYear: { type: 'integer', minimum: 1900, maximum: 2030 },
          birthMonth: { type: 'integer', minimum: 1, maximum: 12 },
          birthDay: { type: 'integer', minimum: 1, maximum: 31 },
          birthHour: { type: 'integer', minimum: 0, maximum: 23, default: 12 },
          locationKey: { type: 'string', default: 'beijing' },
  ...
  paths: {
    ...
    '/api/bazi/calculate': {
      post: {
        summary: '计算八字',
        description: '基于出生信息计算八字排盘',
        requestBody: {
          required: true,
          content: {
            'application/json': {
              schema: { $ref: '#/components/schemas/BaziCalculationRequest' },
            },
          },
        },
        responses: {
          200: {
            ...
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/BaziRecord' },
              },
            },
          },
          400: {
              ...
              'application/json': {
                schema: {
                  ...
                  properties: {
                    records: {
                      type: 'array',
                      items: { $ref: '#/components/schemas/BaziRecord' },
                    },
                    total: { type: 'integer' },
                  },
                },
