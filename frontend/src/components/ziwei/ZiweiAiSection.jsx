...
export default function ZiweiAiSection({ onInterpret, onSave, aiLoading, saveLoading, aiResult }) {
    ...
    <div className="mt-6">
      <div className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-white/10 bg-white/5 p-4">
        ...
        <div className="flex flex-wrap gap-2">
          <Button variant="ghost" onClick={onInterpret} isLoading={aiLoading} disabled={aiLoading}>
            {aiLoading ? t('ziwei.interpreting') : t('ziwei.aiInterpret')}
          </Button>
          <Button onClick={onSave} isLoading={saveLoading} disabled={saveLoading}>
